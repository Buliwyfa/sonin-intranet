...
class RejectRequest extends BaseNotification
{
    /**
     * @inheritdoc
     */
    ...
    {
                return Yii::t('TickreqModule.views_notifications_newupdaterequest', '{username} has <span class="color-red-a700 "><b>rejected</b></span> the request {code}', [
