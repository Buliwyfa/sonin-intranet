...
class ApproveRequest extends BaseNotification
{
    /**
     * @inheritdoc
     */
    ...
    {
                return Yii::t('TickreqModule.views_notifications_newupdaterequest', '{username} has <span class="color-light-green-a700"><b>approved</b></span>  the request {code}.', [
