 ...
 */
class TeavRequest extends BasePermission
{

    /**
     * @inheritdoc
     */
    protected $id = 'teav_request';

    /**
     * @inheritdoc
     */
    protected $title = 'Teav Group View & Create';

    /**
     * @inheritdoc
     */
    protected $description = 'Can request in Teav Group and see only their own request';
