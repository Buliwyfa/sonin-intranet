 ...
 */
class HiaRequest extends BasePermission
{

    /**
     * @inheritdoc
     */
    protected $id = 'hia_request';

    /**
     * @inheritdoc
     */
    protected $title = 'HIA View & Create';

    /**
     * @inheritdoc
     */
    protected $description = 'Can request in HIA and see only their own request';
